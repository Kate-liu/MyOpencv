# -*- coding:utf-8 -*-
# This is a parking recognition VideoData program
import glob
import pickle
import cv2
...
def video_test(video_name, final_spot_dict, model, class_dictionary):
    ...
    parking.predict_on_video(name, final_spot_dict, model, class_dictionary, ret=True)
...
if __name__ == '__main__':
    ...
    # some parameters
    weights_path = "TrainResult/car.h5"
    class_dictionary = {0: 'empty', 1: 'occupied'}
    model = keras_model(weights_path)
    video_name = "VideoData/parking_video.mp4"
    # keras predict
